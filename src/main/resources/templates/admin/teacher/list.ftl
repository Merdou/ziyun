                ...
                <div class="modal-body">
                    <form id="editForm"  class="form-horizontal" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="edit_name" name="name"  data-bv-trigger="blur"   placeholder="专业名称">
                            </div>
                        </div>

                        <div class="form-group">
                            <label  class="col-sm-2 control-label">教授专业</label>
                            <div class="col-sm-10">
                                <select multiple="multiple"  class="form-control" id="edit_teachKnowledge" name="teach">
                                    <#list arrMajor as m>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="edit_mobile" name="mobile"  data-bv-trigger="blur" >
                            </div>
                        </div>
